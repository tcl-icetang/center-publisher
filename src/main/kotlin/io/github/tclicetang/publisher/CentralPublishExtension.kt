...
open class CentralPublishExtension
    @Inject
    constructor(objectFactory: ObjectFactory) {
        ...
        companion object {
            internal fun Project.toSonatypeExtension(): CentralPublishExtension =
                extensions.create("sonatypeCentralPublishExtension", CentralPublishExtension::class.java)
        }
    }
